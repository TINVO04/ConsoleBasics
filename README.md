...
|---|---|---|
| `Day01.ConsoleBasics` | Console App Day 1: nhập/xuất, biến, kiểu dữ liệu, tính toán đơn giản | Hoàn thành, đang chờ review |
...
- Build project `Day01.ConsoleBasics` ở cấu hình Release.

## Trạng thái hiện tại

| Ngày | Nội dung | Trạng thái |
|---|---|---|
| Day 1 | Console basics, biến, kiểu dữ liệu, nhập/xuất, tính toán đơn giản | Hoàn thành, đã tạo Pull Request |
| Day 2 | Input, ép kiểu, `if/else`, `switch`, validate cơ bản | Chưa bắt đầu |
